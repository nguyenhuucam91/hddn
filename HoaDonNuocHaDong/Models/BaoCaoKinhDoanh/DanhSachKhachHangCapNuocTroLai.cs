...
{
    public class DanhSachKhachHangCapNuocTroLai:ModelBase
    {
        ...
        public string Lydocapnuoctrolai { get { return GetSTR(5); } set { SetSTR(5, value); } }
        public DateTime Ngaycaplai { get { return GetDT(6); } set { SetDT(6, value); } }
        public string Ghichu { get { return GetSTR(7); } set { SetSTR(7, value); } }
        public DanhSachKhachHangCapNuocTroLai()
        {
            MaxPosModelField = 7;
        }
