...
namespace HoaDonNuocHaDong.Models.SoLieuTieuThu
{
    public class ThongTinHoaDon : HoaDonNuoc
    {
        ...
        public String MaTuyen { get { return GetSTR(12); } set { SetD(12, value); } }

        #region ThongTinKhachHang
        public new String TenKhachHang { get { return GetSTR(13); } set { SetSTR(13, value); } }
        public String DiaChi { get { return GetSTR(14); } set { SetSTR(14, value); } }
        public String MaSoThue { get { return GetSTR(15); } set { SetSTR(15, value); } }
