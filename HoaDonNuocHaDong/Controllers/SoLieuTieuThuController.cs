...
namespace HoaDonNuocHaDong.Controllers
{
    public class SoLieuTieuThuController : BaseController
    {
            ...
            int SoHoaDon, String dateStart, String dateEnd, String dateInput, int thang, int nam)
        {
            ...
            ThongTinHoaDon obj = cB.Query("ThongTinChiTietHoaDon",
            ...
            if (obj != null)
            {
                ...
                if (obj.LoaiApGiaID != KhachHang.TONGHOP)
                {
                    chiSoChiTiet = cS.tachChiSoSanLuong(_TongSoTieuThu, obj.LoaiApGiaID, obj.SoHo, obj.SoKhau);
                    //massupdate here.
                ...
                lichSuHoaDonRepository.updateLichSuHoaDon(HoaDonID, _month, _year, obj.TenKhachHang, obj.DiaChi, obj.MaSoThue, obj.MaKhachHang, obj.TuyenKHID,
                    obj.SoHopDong, ChiSoDau.Value, ChiSoCuoi.Value, TongSoTieuThu.Value,
            ...
            0, 5, 0,
            obj.TiLePhiMoiTruong, 0,
            0, "",
            "", "", obj.TuyenKHID,
            obj.TTDoc, 0, dateStart, dateEnd);
        ...
        public void tachChiSoSanLuong(int HoaDonID, int ChiSoDau, int ChiSoCuoi, int TongSoTieuThu, int SoKhoan, int KHID)
        {
            ...
            if (hoaDon != null)
            {
                ...
                if (_loaiApGia == HoaDonNuocHaDong.Helper.KhachHang.SINHHOAT)
                {
                    ...
                    int soHo = khachHang.Soho == null ? 1 : khachHang.Soho.Value;
                    int dinhMucCoSo = 10;
        ...
        public void ChinhSuaSoKhoan(int HoaDonID, int? ChiSoDau, int? ChiSoCuoi, int? TongSoTieuThu, int SoKhoan, int KHID, String dateStart, String dateEnd, String sohoadon)
        {
            ...
            lichSuHoaDonRepository.updateLichSuHoaDon(HoaDonID, _month, _year, obj.Ten, obj.Diachi, obj.Masothue, obj.MaKhachHang, obj.TuyenKHID.Value,
                    obj.Sohopdong, ChiSoDau.Value, ChiSoCuoi.Value, TongSoTieuThu.Value,
            ...
            0, 5, 0,
            obj.Tilephimoitruong.Value, 0,
            0, "",
            "", "", obj.TuyenKHID.Value,
            obj.TTDoc.Value, 0, dateStart, dateEnd);
        ...
        public ActionResult ViewDetail(String month, String year, int? tuyenID, int? nvquanly)
        {
            ...
            DateTime thangNamGanNhat = cS.getThangNamGanNhatThuocHoaDon(tuyenID.Value, _month, _year);
            ...
            var dsSanLuongKhongBinhThuong = cS.loadDanhSachSanLuongBatThuong(previousMonth, previousYear, _month, _year, tuyenID.Value);
            ViewBag.soLuongKhongBinhThuong = dsSanLuongKhongBinhThuong.Count();
        ...
        public ActionResult Nhapgiadacbiet(int? id, FormCollection form, int? to, int nhanvien, int tuyen, int thang, int nam)
        {
            ...
            0, "",
            "", "", obj.TuyenKHID.Value,
            obj.TTDoc.Value, 0, startDate, endDate);

            HoaDonNuocHaDong.Helper.HoaDonNuoc.themMoiHoaDonThangSau(KHID, ChiSoCuoi, LoggedInUser.NhanvienID.Value, _month, _year, Convert.ToDateTime(endDate));
